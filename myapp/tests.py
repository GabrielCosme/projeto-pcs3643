...
class VooRealTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        VooReal.objects.create(voo=voo, dia="2020-01-01", status=0, partida_real="11:00", chegada_real="15:00")
    ...
    def test_voo_real_unique(self):
        ...
        with self.assertRaises(Exception):
            VooReal.objects.create(voo=voo, dia="2020-01-01", status=1, partida_real="12:00", chegada_real="16:00")
